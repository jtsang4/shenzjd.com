...
export default {
  ...
  data () {
    return {
      ...
      array: [
        ...
        {
          name: '智能微联100-50叮咚音箱、智能冰箱及部分微联品商品',
  ...
  created () {
    ...
    this.apis = this.apis.concat(this.array)
  },
  components: {
    ticket
  },
